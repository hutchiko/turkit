...
public class RhinoUtil {
	...
	/**
	 * Evaluates the given string in the given context.
	 */
	...
	/**
	 * Evaluates the given file in the given context.
	 */
	...
	/**
	 * Evaluates the given URL in the given context.
	 */
	public static Object evaluateURL(final Context cx, final Scriptable scope,
			final URL url) throws Exception {
		return cx.evaluateReader(scope,
				new InputStreamReader(url.openStream()), url.toString(), 1,
				null);
	}
