...
S3.prototype.putObjectRaw = function(bucketName, key, data) {
	...
	if (!key) {
		key = java_U.getRandomString(32, "0123456789abcdefghijklmnopqrstuvwxyz") + ".html"
	}
...
S3.prototype.putFileRaw = function(bucketName, file) {
	...
	var key = java_U.getRandomString(32, "0123456789abcdefghijklmnopqrstuvwxyz")
