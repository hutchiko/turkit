// this file has been modified by Greg Little

// documentation: http://xmljs.sourceforge.net/website/documentation-classicdom.html
    ...
    *********************************************************************************************************************/
    ...
    str = str.replace(/&[^;]+;/g, function (s) {
        switch(s.substring(1, s.length - 1)) {
            case "amp":  return strEnt = "&";
            case "lt":   return strEnt = "<";
            case "gt":   return strEnt = ">";
            case "apos": return strEnt = "'";
            case "quot": return strEnt = "\"";
            default:
                if(s.charAt(1) == "#") {
