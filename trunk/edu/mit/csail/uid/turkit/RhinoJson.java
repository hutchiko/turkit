...
public class RhinoJson {
	public static Map<Object, String> objToPath;
	public static StringBuffer result;
	public static StringBuffer appendAtEnd;
	...
	public static boolean json_helper_supported_type(Object o) {
		if (o == null) {
	...
	public static void json_helper(Object o, String indent, String path,
			String appendIndent) {
		if (o == null) {
			result.append("null");
		} else if (o instanceof NativeJavaObject) {
	...
	public static Object objGet(NativeObject o, Object id) {
